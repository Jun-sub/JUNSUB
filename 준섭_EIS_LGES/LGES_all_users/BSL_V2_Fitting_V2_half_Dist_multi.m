...
% Parameters 
    ...
    factors_temp = load("C:\Users\admin\Documents\GitHub\JunSub\준섭_EIS_LGES\10월 미팅\Av_integ_V2\241209_Test_epsla_and_Del_fitting\3E simul P2D + soc integrated + DRT + DDT integ workspace.mat", 'factors_integ_hat_dist');
    factors_ini(7) = factors_temp.factors_integ_hat_dist(3,15);
    % factors_ini(6) = factors_temp.factors_integ_hat(2,15);
