...
elseif type_acf == 4 
    ...
    % DRT & DDT lb & ub 
    lb((length(factors_ini)-2)/2+1:(length(factors_ini)-2)/2+2,1:2*length(multi_soc_range)) = 0.1;
    ub((length(factors_ini)-2)/2+1:(length(factors_ini)-2)/2+2,1:2*length(multi_soc_range)) = 2;
