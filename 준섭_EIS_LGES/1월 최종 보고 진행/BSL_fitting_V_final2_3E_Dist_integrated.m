...
%% 3E_Simul script
    ...
    options_dist= optimset('Display','iter','MaxIter',num_iter_dist,'MaxFunEvals',1e6,...
        ...
        % Start multi-soc fitting
           ...
           [f_data, z_data_integ_sep, z_model_integ_sep, z_model_dist_integ_sep, paras_integ ,paras_integ_dist] = BSL_func_3E_calc_el_multi_soc_V_final2(path_folder, path_file, multi_soc_range, cell_type, []);
