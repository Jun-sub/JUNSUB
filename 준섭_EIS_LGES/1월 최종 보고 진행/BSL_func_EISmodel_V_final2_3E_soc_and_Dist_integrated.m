function [output,paras] = BSL_func_EISmodel_V_final2_3E_soc_and_Dist_integrated(f_vector,factors,multi_soc_range,T,type_acf,cell_type,type_dist)
...
%% Kinetics Parameters
    ...
    % Di0 = factors(9,i)*De_function(c_e/1000,T);
...
% Parameter Expressions
    ...
    dUdca = ((1/cta)*(Ua_function_v3(soc+dx) - Ua_function_v3(soc-dx))/(2*dx))-y_shift; %1.098543764913605e-06;
...
parasc(:,i) = [R_itscc(i), i0c, Cdlc, Dsc, ac, std_drt_ra,std_ddt_ra, std_drt_rc,std_ddt_rc, kappa, Di0]';
    end 
